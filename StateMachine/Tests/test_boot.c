...
int main(void)
{
    ...
    for (;;)
    {
        ...
        /*
         * BOOT cyclic phases are designed around the robot's
         * nominal 1 ms EtherCAT cycle.
         */
        sleep_1ms();
    }
    ...
    /*
     * BOOT finished with the drives Operation Enabled.
     *
     * Since this executable ends immediately afterward, walk the drives
     * backwards through CiA-402 before closing EtherCAT.
     */
    disable_drives();
